...
it('event-info-init', function() {
    ...
    log('');
    log(' *****************************');
    log('  requesting-funds-test-1.js  ');
    log(' *****************************');
    log('');    
...
it('redeem-proposal-4', function() {
    log("");
    log(" (!) Action: [0xcc49] collect 1,000,000.000 HKG value of proposal 4");
                           
    return dstContract_APL.redeemProposalFunds(proposal_4, 
    {
       from : '0xcc49bea5129ef2369ff81b0c0200885893979b77',   
       gas : 350000,       
    })
...
it('redeem-proposal-5', function() {
    log("");
    log(" (!) Action: [0xcc49] collect 1,000,000.000 HKG value of proposal 5");
                           
    return dstContract_APL.redeemProposalFunds(proposal_5, 
    {
       from : '0xcc49bea5129ef2369ff81b0c0200885893979b77',   
       gas : 350000,       
    })
