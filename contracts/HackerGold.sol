 ...
 *
 * Reviewed based on guidelines here http://ethereum.stackexchange.com/questions/8551/methodological-security-review-of-a-smart-contract
 *
 */
 /// @title Hacker Gold
contract HackerGold is StandardToken {
    ...
    function HackerGold(address multisig) {
        ...
        milestones = milestones_struct(
          ...
          // REVIEW: numbers match the dates int the comments
    ...
    function createHKG(address holder) payable {
        ...
        // Review:
        // This rounds down the value and because divider is
        // always larger than getPrice() there should be
        // no overflow issues.
        // Division round down: Not sure if we want to round down message value here,
        // as this might cause misunderstanding for buyers.
     ...
     *
     * Review: Price graph is available at https://github.com/ether-camp/virtual-accelerator/issues/1
     *
